...
interface ClientMarketingAutomationPageProps {
...
const ProjectTimeline: FC = () => (
  <div className="flex flex-wrap justify-center items-center gap-6 text-sm mb-12">
    <div className="flex items-center">
      ...
      <span className="font-medium text-gray-700">Analysis: Jun 2023</span>
    </div>
    ...
    <div className="flex items-center">
      ...
      <span className="font-medium text-gray-700">Development: Jul-Nov 2023</span>
    </div>
    <div className="w-12 h-px bg-blue-200 hidden md:block"></div>
    <div className="flex items-center">
      ...
      <span className="font-medium text-gray-700">Launch: Dec 2023</span>
    </div>
  </div>
)

// Main client-side component with interactive elements
const ClientMarketingAutomationPage: FC<ClientMarketingAutomationPageProps> = ({ projectData }) => {
  ...
  return (
    <main className="relative bg-white">
      ...
      <CTA 
        heading="Need a powerful marketing automation solution?"
        subheading="Let's build a custom platform that streamlines your campaigns, enhances your analytics, and drives measurable business growth."
      ...
      {showStickyButton && (
        ...
        >
          <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center">
              <div className="text-blue-400 text-3xl font-bold mr-3">+52%</div>
              <div className="text-gray-300">Engagement metrics increase</div>
            </div>
            <Link 
              href="/contact"
...
export default ClientMarketingAutomationPage 