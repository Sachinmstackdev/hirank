...
interface ClientGiftWrapPageProps {
...
const ClientGiftWrapPage: FC<ClientGiftWrapPageProps> = ({ projectData }) => {
      ...
      {showStickyButton && (
        ...
        >
          <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center">
              <div className="text-blue-400 text-3xl font-bold mr-3">+210%</div>
              <div className="text-gray-300">Year-over-year growth</div>
            </div>
            <Link 
              href="/contact"
...
export default ClientGiftWrapPage 