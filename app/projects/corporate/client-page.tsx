...
interface ClientCorporatePageProps {
...
const ProjectTimeline: FC = () => (
  <div className="flex flex-wrap justify-center items-center gap-6 text-sm mb-12">
    <div className="flex items-center">
      ...
      <span className="font-medium text-gray-700">Discovery: Mar 2023</span>
    </div>
    ...
    <div className="flex items-center">
      ...
      <span className="font-medium text-gray-700">Design: May 2023</span>
    </div>
    <div className="w-12 h-px bg-blue-200 hidden md:block"></div>
    <div className="flex items-center">
      ...
      <span className="font-medium text-gray-700">Launch: Aug 2023</span>
    </div>
  </div>
)

// Main client-side component with interactive elements
const ClientCorporatePage: FC<ClientCorporatePageProps> = ({ projectData }) => {
  ...
  return (
    <main className="relative bg-white">
      ...
      <CTA 
        heading="Ready to transform your brand identity?"
        subheading="Let's create a powerful, consistent brand and website that builds trust with your audience and drives measurable business results."
        ...
        trustPoints={[
          ...
          "Conversion-focused methodology",
          "ROI-driven approach to branding"
        ]}
      />
      ...
      {showStickyButton && (
        ...
        >
          <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center">
              <div className="text-blue-400 text-3xl font-bold mr-3">+128%</div>
...
export default ClientCorporatePage 