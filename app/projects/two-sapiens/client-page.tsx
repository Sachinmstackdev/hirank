...
const ClientTwoSapiensPage: FC<ClientTwoSapiensPageProps> = ({ projectData }) => {
  ...
  return (
    <main className="relative bg-white">
      ...
      <CTA 
        heading="Ready to transform your e-commerce brand?"
        subheading="Let's create a conversion-focused digital experience that elevates your brand and drives measurable business growth."
        ...
        trustPoints={[
          ...
          "Award-winning team with proven results",
          "Intelligence-driven strategies tailored to your goals"
        ]}
      />
      ...
      {showStickyButton && (
        ...
        >
          <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center">
              <div className="text-blue-400 text-3xl font-bold mr-3">+40%</div>
