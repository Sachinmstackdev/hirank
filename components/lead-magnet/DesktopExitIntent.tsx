      ...
      <DialogContent className="sm:max-w-[550px] p-0 gap-0 rounded-2xl overflow-hidden border-0 shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-500 py-10 px-8 relative">
          ...
          <button 
            ...
            className="absolute top-4 right-4 z-50 w-10 h-10 bg-white/20 backdrop-blur-sm hover:bg-white/30 rounded-full flex items-center justify-center focus:outline-none transition-all duration-200 hover:rotate-90"
          >
          ...
          >
            ...
            <p className="text-center text-blue-100 text-base px-8 leading-relaxed">
